...
public:
	...
	void addActiveFrame(ImageAndExposure* image, int id, bool half_resolution);
	...
	// Seong addition:
	void marginalizeEverythingByForce();
...
private:
	...
	void flagAllPointsForRemoval();
	void makeNewTraces(FrameHessian* newFrame, float* gtDepth);
	void initializeFromInitializer(FrameHessian* newFrame);
	void flagFramesForMarginalization(FrameHessian* newFH);
	void flagAllFramesForMarginalization();
